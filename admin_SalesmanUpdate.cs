...
{
    public partial class admin_SalesmanUpdate : Form
    {
        OracleConnection con;
        public admin_SalesmanUpdate()
        {
            InitializeComponent();
        }
        ...
        private void admin_SalesmanUpdate_Load(object sender, EventArgs e)
        {
        ...
        {
            string salesmanId = textBox1.Text.Trim();


            OracleCommand cmd = new OracleCommand("SELECT * FROM SALESMAN WHERE Salesman_ID = :salesmanId", con);
            cmd.Parameters.Add("salesmanId", OracleDbType.Varchar2).Value = salesmanId;
            ...
            {
                MessageBox.Show("Salesman ID not found.");
            }
        ...
        private void button2_Click_1(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                {
                    cmd.CommandText = "UPDATE SALESMAN SET Name = :name, Account_No = :accountNo, Contact = :contact, Email = :email, Password = :password, Username = :username WHERE Salesman_ID = :salesmanId";
                    ...
                    cmd.Parameters.Add("salesmanId", OracleDbType.Varchar2).Value = textBox1.Text.Trim();
        ...
        private void admin_SalesmanUpdate_Load_1(object sender, EventArgs e)
        {

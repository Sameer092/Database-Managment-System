...
{
    public partial class admin_SalesmanAdd : Form
    {
        OracleConnection con;
        public admin_SalesmanAdd()
        {
            InitializeComponent();
        }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                insertCRUD.CommandText = "INSERT INTO SALESMAN(Salesman_ID,Name,Account_No,Contact,Email,Password,Username) VALUES (salesman_seq.nextval, '" + textBox1.Text.ToString() + "','" + textBox5.Text.ToString() + "','" + textBox6.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + textBox4.Text.ToString() + "')";
        ...
        private void admin_SalesmanAdd_Load(object sender, EventArgs e)
        {
            string conStr = @"DATA SOURCE = localhost:1521/XE; USER ID=FINALPROJECT;PASSWORD=fullmarks100";
            con = new OracleConnection(conStr);
        }

        private void admin_SalesmanAdd_Load_1(object sender, EventArgs e)
        {

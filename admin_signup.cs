...
namespace Managment_System
{
    public partial class admin_signup : Form
    {
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                insertCRUD.CommandText = "INSERT INTO ADMIN(Admin_ID,Name,Account_No,Contact,Email,Password,Username) VALUES (admin_seq.nextval, '" + textBox1.Text.ToString() + "','" + textBox5.Text.ToString() + "','" + textBox6.Text.ToString() + "','" + textBox3.Text.ToString() + "','" + textBox2.Text.ToString() + "','" + textBox4.Text.ToString() + "')";
